...
- Report issues already tracked in GitHub issues #13-#20 (update restart overlap, session permission restore, diff/filetree card redesign, shortcuts overflow, GitHub login failure, open report lost on restart, light sweep effect, onboarding tutorial)
...
- Before finishing, write `.hydra-result-hydra-41bc2a2c0bd18fc8.md` in the worktree root with:
