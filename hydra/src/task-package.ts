...
function renderEvaluatorVerificationStrategy(role: string): string[] {
  ...
  return [
    ...
    "",
    "Include a `quality_score` (0-10) in the verification object. This is your holistic assessment of the implementation quality:",
    "- 9-10: Excellent — exceeds requirements, clean code, well-tested, no issues found",
    "- 7-8: Good — meets requirements with minor issues that don't affect correctness",
    "- 5-6: Adequate — meets core requirements but has notable quality concerns",
    "- 3-4: Below standard — significant issues that should be addressed",
    "- 0-2: Failing — fundamental problems, broken functionality, or hacked tests",
    "",
  ];
}
