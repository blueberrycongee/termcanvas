export const en = {
  ...
  hydra_tab: "Hydra",
  hydra_no_workflows: "No workflows",
  hydra_no_workflows_hint: "Run hydra run to start a workflow.",
  hydra_status_pending: "Pending",
  hydra_status_running: "Running",
  hydra_status_challenging: "Challenging",
  hydra_status_waiting_for_approval: "Awaiting approval",
  hydra_status_completed: "Completed",
  hydra_status_failed: "Failed",
  hydra_handoff_pending: "Pending",
  hydra_handoff_claimed: "Claimed",
  hydra_handoff_in_progress: "In progress",
  hydra_handoff_completed: "Done",
  hydra_handoff_timed_out: "Timed out",
  hydra_handoff_failed: "Failed",
