export const en = {
  ...
  git_history: "History",
  git_loaded_commits: "Loaded",
  git_contributors: "Authors",
  git_refs: "Refs",
  git_merges: "Merges",
  git_local_branches: "Locals",
  git_remote_branches: "Remotes",
  git_files: "Files",
  git_images: "Images",
  git_renames: "Renames",
  git_up_to_date: "Up to date",
  git_merge_label: "merge",
  git_image_label: "image",
  git_rename_label: "rename",
  git_inspector: "Inspector",
  git_refresh: "Refresh",
  git_no_commits: "No commits yet",
  git_load_more: "Loading more commits\u2026",
  git_commit_detail: "Commit Detail",
  git_no_commit_selected: "Select a commit to inspect it",
  git_refresh_failed: (message: string) => `Failed to refresh Git panel: ${message}`,
  git_checkout_failed: (message: string) => `Failed to switch branch: ${message}`,
  git_init_failed: (message: string) => `Failed to initialize repository: ${message}`,
  git_commit_detail_failed: (message: string) => `Failed to load commit detail: ${message}`,
