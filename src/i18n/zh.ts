export const zh = {
  ...
  hydra_tab: "Hydra",
  hydra_no_workflows: "暂无工作流",
  hydra_no_workflows_hint: "运行 hydra run 启动工作流",
  hydra_status_pending: "等待中",
  hydra_status_running: "运行中",
  hydra_status_challenging: "挑战中",
  hydra_status_waiting_for_approval: "等待审批",
  hydra_status_completed: "已完成",
  hydra_status_failed: "失败",
  hydra_handoff_pending: "等待中",
  hydra_handoff_claimed: "已认领",
  hydra_handoff_in_progress: "执行中",
  hydra_handoff_completed: "完成",
  hydra_handoff_timed_out: "超时",
  hydra_handoff_failed: "失败",
  usage_monthly: "本月累计",
  usage_sessions: "会话",
  usage_output: "输出",
  usage_timeline: "时段",
