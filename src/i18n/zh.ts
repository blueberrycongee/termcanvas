export const zh = {
  ...
  git_selected: "选中",
  git_history: "历史",
  git_loaded_commits: "已载入",
  git_contributors: "作者",
  git_refs: "Refs",
  git_merges: "合并",
  git_local_branches: "本地",
  git_remote_branches: "远程",
  git_files: "文件",
  git_images: "图片",
  git_renames: "重命名",
  git_up_to_date: "已同步",
  git_merge_label: "合并",
  git_image_label: "图片",
  git_rename_label: "重命名",
  git_inspector: "检查器",
  git_refresh: "刷新",
  git_no_commits: "当前还没有 commit",
  git_load_more: "正在加载更多 commit…",
  git_commit_detail: "Commit 详情",
  git_no_commit_selected: "选择一个 commit 查看详情",
  git_refresh_failed: (message: string) => `刷新 Git 面板失败：${message}`,
  git_checkout_failed: (message: string) => `切换分支失败：${message}`,
  git_init_failed: (message: string) => `初始化仓库失败：${message}`,
  git_commit_detail_failed: (message: string) => `加载 commit 详情失败：${message}`,
