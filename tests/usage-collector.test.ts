...
test("parseClaudeSession maps Hydra .worktrees path to parent project", () => {
  ...
  // encoded: -Users-zzzz-myproject-.worktrees-hydra-abc123
  ...
  try {
    ...
    // Should strip .worktrees suffix and map to parent project
...
test("parseClaudeSession maps EnterWorktree --worktrees path to parent project", () => {
  // EnterWorktree creates worktrees at repo--worktrees/branch
  // encoded: -tmp-test-proj--worktrees-feature-branch
  const { filePath, dir } = writeClaudeJsonl(
